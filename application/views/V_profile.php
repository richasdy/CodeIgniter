    ...
    <main id="profile">
        <header class="profile__header">
            <div class="profile__column">
                <img src="<?= base_url('assets/images/Bagas.jpg'); ?>" />
            </div>
            <div class="profile__column">
                <div class="profile__title">
                    ...
                    <a href="<?= site_url('Vietgram/do_logout') ?>">Logout</a>
                ...
                <p class="profile__bio">
                    ...
                    <a href="https://www.youtube.com/channel/UC5VwPtGkSMSoKPccaZAPSXQ?view_as=subscriber"><?= $this->session->userdata('website'); ?></a>
                </p>
            </div>
        </header>
