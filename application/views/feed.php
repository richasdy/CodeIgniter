    ...
    <main id="feed">
        ...
        <div class="photo">
            <header class="photo__header">
                <img src="assets/images/anang.jpg" class="photo__avatar" />
                <div class="photo__user-info">
                    <span class="photo__author"><?php echo $_SESSION['username'];?></span>
                    <span class="photo__location">Yogyakarta</span>
                </div>
            </header>
            <img class="img-fluid" height="auto" width="auto" src="assets/images/foto_user/<?php echo $_SESSION['username']."/".$row[$i]->gambar; ?>" /></<img>
            <div class="photo__info">
                ...
                <span class="photo__likes"> <?= rand(0,112);?> likes</span>
