        ...
        <main id="feed">
            ...
            <div class="photo">
                <header class="photo__header">
                    <img src="assets/images/feed_izzan/izzanfr/gambar2.jpg" class="photo__avatar" />
                    <div class="photo__user-info">
                        <span class="photo__author"><?php echo $_SESSION['username'];?></span>
                    </div>
                </header>
                <center><img class="img-fluid" height="500px" width="600px" src="assets/images/feed_izzan/<?php echo $_SESSION['username']."/".$row[$i]->url; ?>" /></center>
