            ...
            <div class="login__column">
                ...
                <div class="login__box--transparent">
                    ...
                    <div class="login__appstores">
                        ...
                        class="login__appstore" alt="Apple appstore logo" title="Apple appstore logo" />
                        <img src="<?php echo base_url();?>assets/images/android.png" class="login__appstore" 
                        alt="Android appstore logo" title="Android appstore logo" />
                    </div>
                </div>
            </div>
        </main>
