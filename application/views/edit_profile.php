        ...
        <div class="edit-profile__container">
            <header class="edit-profile__header">
                <div class="edit-profile__avatar-container">
                    <img src="assets/images/<?php echo $_SESSION['username']?>/avatar.jpg" class="edit-profile__avatar" />
                </div>
            ...
            <form action="<?php base_url()?>edit_Profile/editprofile" class="edit-profile__form" method="post">
                ...
                <div class="form__row">
                    ...
                    <input name="no_hp" type="tel" class="form__input" value="<?php echo $data['no_hp']?>"/>
                </div>
                <div class="form__row">
