    ...
    <main id="feed">
        ...
        ?>
            <div class="photo">
                <header class="photo__header">
                    <img src="<?= base_url('assets/images/maul.jpg') ?>" class="photo__avatar" />
                    <div class="photo__user-info">
                        <span class="photo__author"><?= $this->session->userdata('username'); ?></span>
                        <span class="photo__location">SAO</span>
                    </div>
                </header>
                ...
                <div class="photo__info">
                    ...
                    <ul class="photo__comments">
                        <li class="photo__comment">
                            <span class="photo__comment-author">maulanairfanf</span> <?= $row["caption"] ?>
                        </li>
                    </ul>
        ...
        <div class="photo">
            <header class="photo__header">
                ...
                <div class="photo__user-info">
                    <span class="photo__author"><?= $this->session->userdata('username'); ?></span>
                    <span class="photo__location">Hutan Utara</span>
                </div>
            </header>
            ...
            <div class="photo__info">
                ...
                <ul class="photo__comments">
                    ...
                    <li class="photo__comment">
                        <span class="photo__comment-author">Dani</span> love this!
                    </li>
                    <li class="photo__comment">
                        <span class="photo__comment-author">Aziz</span> love this!
                    </li>
                    <li class="photo__comment">
                        <span class="photo__comment-author">Nopal</span> love this!
                    </li>
                </ul>
                <span class="photo__time-ago">2 hours ago</span>
                <div class="photo__add-comment-container">
