        ...
        <div class="edit-profile__container">
            ...
            <form action="" method="post" class="edit-profile__form">
                ...
                <div class="form__row">
                    ...
                    <input id="user-name" type="text" class="form__input" name="username "value="<?php echo $profile->sername ?>" />
                </div>
                <div class="form__row">
                ...
                <div class="form__row">
                    ...
                    <textarea id="bio" name="bio" value="<?php echo $profile->bio ?>"></textarea>
                </div>
                <div class="form__row">
                ...
                <div class="form__row">
                    ...
                    <input id="phone" type="tel" class="form__input" name="phone" value="<?php echo $profile->phone ?>"/>
                </div>
                <div class="form__row">
