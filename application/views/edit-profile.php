...
<body>
    ...
    <main id="edit-profile">
        <div class="edit-profile__container">
            ...
            <form action="<?php echo base_url('C_profile/edit');?>" class="edit-profile__form" method="POST">
                <div class="form__row">
                ...
                <div class="form__row">
                    ...
                    <input id="phone" type="tel" class="form__input" name="phonenumber" value="<?=$profile['phone']?>"/>
                </div>
                <div class="form__row">
