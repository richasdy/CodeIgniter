<?php 
    // session_start();
    $data_photo = $this->db->query("select * from tbl_photo where username='". $_SESSION['username']. "'");
    // $data_profile = $this->db->where('username', $username);
    $data = $this->db->get('tbl_profile')->row_array();
    ...
    <main id="profile">
        <header class="profile__header">
            <div class="profile__column">
                <img width="200px" height="200px" src="assets/images/<?php echo $_SESSION['username'];?>/avatar.jpg" />
            </div>
            <div class="profile__column">
                ...
                <ul class="profile__stats">
                    <li class="profile__stat">
                        <span class="stat__number"><?= $jmlData; ?></span> posts
                    </li>
                    <li class="profile__stat">
                ...
                <p class="profile__bio">
                    ...
                    <b><a href='<?php echo $data['website'];?>' target='blank'> <?php echo $data['website'];?></a></b><br>
                </p>
            </div>
        </header>
