    ...
    <main id="profile">
        <header class="profile__header">
            <div class="profile__column">
                <img src="assets/images/anang.jpg" width="150px" height="150px"  />
            </div>
            <div class="profile__column">
                ...
                <ul class="profile__stats">
                    <li class="profile__stat">
                        <span class="stat__number"><?= $jumInfo; ?></span> posts
                    </li>
                    <li class="profile__stat">
                ...
                <p class="profile__bio">
                    ...
                    <b href="<?= $data['website']; ?>"><?php echo $data['website'];?></b><br>
                </p>
            </div>
        </header>
        ...
        ?>
            <div class="profile__photo">
                <img src="assets/images/foto_user/<?php echo $_SESSION['username']."/".$row[$i]->gambar; ?>" width="300px" height="300px" />
