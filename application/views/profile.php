...
<body>
    <nav class="navigation">
        <div class="navigation__column">
            <a href="<?php echo base_url('C_Feed');?>">
        ...
        <div class="navigation__column">
            <ul class="navigations__links">
                ...
                <li class="navigation__list-item">
                    <a href="<?php echo base_url('C_profile');?>" class="navigation__link">
        ...
        <header class="profile__header">
            ...
            <div class="profile__column">
                <div class="profile__title">
                    ...
                    <a href="<?php echo base_url('C_profile/edit');?>">Edit profile</a>
                ...
                <ul class="profile__stats">
                    ...
                    <li class="profile__stat">
                        <span class="stat__number">872</span> followers
                    </li>
                    <li class="profile__stat">
                        <span class="stat__number">201</span> following
                    </li>
                </ul>
